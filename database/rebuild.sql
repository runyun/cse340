...
CREATE TABLE public.account_type (
  ...
  account_name CHARACTER VARYING NOT NULL, 
	CONSTRAINT account_type_pk PRIMARY KEY (account_id)
) ;
...
CREATE TABLE IF NOT EXISTS public.inventory(
	...
	classification_id integer NOT NULL, CONSTRAINT inventory_pkey PRIMARY KEY (inv_id)
) ;
...
-- Create relationship between 'account' and 'account_type' tables
ALTER TABLE IF EXISTS public.account
	ADD CONSTRAINT fk_account FOREIGN KEY (account_id)
	REFERENCES public.account_type (type_id) MATCH SIMPLE
	ON UPDATE CASCADE
	ON DELETE NO ACTION;
